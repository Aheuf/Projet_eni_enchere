...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-around">
            ...
            <form method="GET" class="row col-md-12 col-sm-12 ">
                ...
                <div class="row col-sm-12 col-lg-12">
                    <div class="d-flex mb-3 col-lg-5 col-sm-12">
                      <label for="inputMotDePasse" class="col-3 form-label mt-1 ">Mot de passe :</label>
                ...
                <div class="d-flex justify-content-around">
                <!-- formulaire "Creer" (si c'est ok alors il passe à l'état connecté et redirection Accueil : 'liste des enchères') --> 
                <input type="submit" name="btCreer" value="Creer" class="col-md-2 btn btn-lg btn-dark" title="Créer"/>

                <!-- formulaire "Annuler" (pas d'enregistrement de nouvel utilisateur et redirection Accueil) -->
                <input type="reset" name="btAnnuler" value="Annuler" class="col-md-2 btn btn-lg btn-dark" title="Annuler" />
                </div>
