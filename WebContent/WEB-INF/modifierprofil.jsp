  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <a class="nav-link text-light text-end" href="#"><i class="bi bi-box-arrow-left text-danger">
            Déconnexion</i></a>
      </div>
    </nav>
  </header>
    ...
    <div class="container">
      <div class="d-flex justify-content-around">
        ...
        <form method="GET" action="#" class="row col-md-12 col-sm-12 ">
          ...
          <div class="row col-sm-12 col-lg-12">
            <div class="d-flex mb-3 col-lg-5 col-sm-12">
              <label for="inputMotDePasse" class="col-3 form-label mt-1 ">Mot de passe actuel :</label>
              <input type="password" class="form-control" id="inputMotDePasse" aria-describedby="motDePasseHelp">
            </div>
          </div>
          ...
          <div class="row col-sm-12 col-lg-12">
            <div class="d-flex mb-3 col-lg-5 col-sm-12">
              <label for="inputNouveauMotDePasse" class="col-3 form-label mt-1 ">Nouveau mot de passe :</label>
              <input type="password" class="form-control" id="inputNouveauMotDePasse" aria-describedby="motDePasseHelp">
            </div>
            <div class="d-flex mb-3 offset-lg-2 col-lg-5 col-sm-12">
          ...
          <div class="d-flex justify-content-around mb-5">
            <!-- bouton "Enregistrer" -->
            <input type="submit" name="btEnregistrer" value="Enregistrer" class="col-md-2 btn btn-lg btn-dark"
              title="Enregistrer" />
            <!-- bouton "Supprimer mon compte -->
            <a href="" class="col-md-2 btn btn-lg btn-outline-dark">Supprimer profil</a>
          </div>
